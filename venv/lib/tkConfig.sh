...
# installed.
TK_PREFIX='/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib/libtkstub8.6.a'
