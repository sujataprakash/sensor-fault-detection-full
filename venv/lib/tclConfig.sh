...
# installed.
TCL_PREFIX='/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/include -fdebug-prefix-map=/var/folders/sy/f16zz6x50xz3113nwtb9bvq00000gp/T/abs_a0b3437e-5427-478c-9c0d-3bf16a61dfacwyldasds/croots/recipe/tk_1654088774077/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -isystem /SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/include -mmacosx-version-min=10.9 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib -L/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/include'
...
TCL_PACKAGE_PATH='{/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/SUJATA/IRP/projects/project1_sensor_fault_detection/sensor-fault-detection_1/venv/lib/libtclstub8.6.a'
